...
const socialLinks = [
  {
    name: 'Twitter / X',
    href: 'https://x.com/adullam_consult',
    icon: (
  ...
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/adullamconsult',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/adullam_consulting',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
          ...
          <div className="footer__brand">
            <Link to="/" className="footer__logo">
              <span className="footer__logo-text">
                <span className="footer__logo-name">Adullam Consulting</span>
                <span className="footer__logo-sub">Limited</span>
              </span>
            </Link>
            <p className="footer__tagline">
              Strategic advisory and global consulting for organisations that demand excellence.
            </p>
